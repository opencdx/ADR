...
public class NatsOpenCDXMessageServiceImpl implements OpenCDXMessageService {
    ...
    public NatsOpenCDXMessageServiceImpl(
        ...
        try {
            ...
            if (streamInfo != null) {
                ...
                throw new NotFoundException("Failed to create JetStream");
            }
        } catch (JetStreamApiException | IOException e) {
            throw new NotFoundException("Failed to create JetStream", e);
        }
    }
        ...
        try {
            ...
            natsConnection
                    ...
                    .subscribe(
                            subject,
                            dispatcher,
                            new NatsMessageHandler(handler, this.objectMapper, this.tracer),
                            true,
                            subscribeOptions);
    ...
    public void send(String subject, Object object) {
        ...
        try (Tracer.SpanInScope ws = tracer.withSpan(span)) {
            ...
            span.error(e);
            NotFoundException openCDXNotAcceptable =
                    new NotFoundException("Failed NATS Publish on: " + object.toString(), e);
    ...
    protected static class NatsMessageHandler implements MessageHandler {
        ...
        public void onMessage(Message msg) {
            ...
            try {
                ...
                throw new NotFoundException("Failed to read NATS Message", e);
            }
