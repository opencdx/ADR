...
public class OpenCDXIKMServiceImpl implements OpenCDXIKMService {
    ...
    public OpenCDXIKMServiceImpl(TinkarConceptRepository conceptRepository) {
        ...
        if(!this.conceptRepository.existsByConceptId(UUID.fromString("9a6877c0-04b7-4d5d-9766-8695192790d4"))) {
            this.conceptRepository.save(new TinkarConceptModel(UUID.fromString("9a6877c0-04b7-4d5d-9766-8695192790d4"), "day", "258703001 | day (qualifier value)"));
        }
        if(!this.conceptRepository.existsByConceptId(UUID.fromString("3a44167a-e94a-4962-8d2e-d94e57475732"))) {
            this.conceptRepository.save(new TinkarConceptModel(UUID.fromString("3a44167a-e94a-4962-8d2e-d94e57475732"), "month", "258706009 | month (qualifier value)"));
        }
