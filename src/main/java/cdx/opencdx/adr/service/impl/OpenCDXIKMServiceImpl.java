...
public class OpenCDXIKMServiceImpl implements OpenCDXIKMService {
    public static final String UNIT_INCH = "81bafefa-819a-31e9-882a-b0020ad95be6";
    public static final String UNIT_METER = "757702f5-2516-4d25-ab74-4a226806857f";
    public static final String UNIT_POUNDS = "c5cd4522-8276-35a2-97c6-0c40e980986f";
...
//Units
        ...
        addConceptIfMissing(UNIT_DAY, "day", "258703001 | day (qualifier value)");
        addConceptIfMissing(UNIT_MONTH, "month", "258706009 | month (qualifier value)");
        addConceptIfMissing(UNIT_YEAR, "year", "258707000 | year (qualifier value)");
        addConceptIfMissing(UNIT_SECONDS, "Seconds", "257997001 | Seconds (qualifier value)");
        addConceptIfMissing(OpenCDXIKMServiceImpl.UNIT_METER, "meter", "258669008 | meter (qualifier value)");
        addConceptIfMissing(OpenCDXIKMServiceImpl.UNIT_INCH, "inch", "258677007 | inch (qualifier value)");
        addConceptIfMissing(OpenCDXIKMServiceImpl.UNIT_POUNDS, "pounds", "258693003 | pounds (qualifier value)");
        addConceptIfMissing(OpenCDXIKMServiceImpl.UNIT_KILOGRAMS, "kilogram", "258683005 | kilogram (qualifier value)");
        addConceptIfMissing(OpenCDXIKMServiceImpl.UNIT_MINUTE, "minute", "1156209001 | minute (qualifier value)");
        addConceptIfMissing(OpenCDXIKMServiceImpl.UNIT_HOUR, "kilograms", "2258702006 | hour (qualifier value)"); // There seems to be a typo here. It should likely be "hour" instead of "kilograms"
        addConceptIfMissing(OpenCDXIKMServiceImpl.UNIT_DATE, "date", "410672004 | Date property (qualifier value)");
        addConceptIfMissing(OpenCDXIKMServiceImpl.UNIT_CALENDAR_TIME, "calendar time", "Unit of calendar time");
