 ...
 * https://github.com/Ghost-Programmer/mymiller_extensions/blob/master/src/main/java/name/mymiller/utils/ListUtils.java
...
public class ListUtils {
    ...
    public static <E> List<E> filter(List<E> list, Predicate<E> predicate) {
        return ListUtils.safe(list).stream().filter(predicate).toList();
    }
    ...
    public static <E, R> List<R> getValue(List<E> list, Function<? super E, ? extends R> getter) {
        return (List<R>) ListUtils.safe(list).stream().map(getter).toList();
    }
    ...
    public static <E, R> Map<R, E> toMap(List<E> list, Function<? super E, ? extends R> getter) {
        return ListUtils.safe(list).stream().collect(Collectors.toMap(getter, Function.identity()));
    }
}